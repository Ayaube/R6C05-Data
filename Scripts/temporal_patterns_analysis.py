...
def analyze_temporal_patterns():
    ...
    ax2.set_title('Montant Moyen des Transactions par Jour')
    ax2.set_xlabel('Jour')
    ...
    ax3.set_title('Distribution du Nombre de Transactions par Jour')
    ...
    ax4.set_xlabel('Nombre de Transactions')
